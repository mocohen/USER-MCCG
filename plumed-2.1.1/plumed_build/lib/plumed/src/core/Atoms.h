...
//***** MCCG
  std::vector<double> engineArgs;
  bool engineArgsHaveBeenSet;
//***** END MCCG  
  Tensor box;
  Pbc&   pbc;
  Tensor virial;
...
//***** MCCG
  void setEngineArgs(void*);
  void getEngineArgs(double*);//const{return engineArgs;}
  void initEngineArgs(int nEngineArgs);
  void updateEngineArgs();
  int getEngineArgsSize();
//***** END MCCG   
